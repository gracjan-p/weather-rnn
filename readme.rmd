...
### Average temperature
The maximum and minimum temperature series followed near-identical temporal patterns with a stable vertical shift. <br>
Basing on this strong correlation I've decided to replace them with _average temperature_ which is basically mean value of these two series. <br>
...
I think this is a good starting point to understand recurrent neural networks.
